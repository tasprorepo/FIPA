...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><img src="plugins/fipa/img/fipa_logo.png"  alt="FIPA Logo" style="width: 150px;height:65px;padding:10px;"></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top"  id="headerSection">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
          <div class="btnStyle">
			          <button type="button"  id="btnSaveProfile" class="btn BtnFIPASRCH StylishSAVE" onclick="fipaSave()">
			      			<span class="txt">Save Profile</span>
			      			<span class="round"><i class="fa fa-floppy-o"></i></span>
			    		</button>   
				</div>	
			    </li>
				<li><div class="btnStyle">
					 <button type="button"  id="btnNewProfile" class="btn BtnFIPASRCH StylishSAVE" onclick="fipaNewProfile()">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="font-size:140%">
               <i class="fa fa-user-circle"></i>
              <span class="hidden-xs">Welcome,${LOGGED_USER_ADVSTFINITIAL}</span> 
            </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <!-- <li class="header">MAIN NAVIGATION</li>      -->   
         ...
         <li class="mainmenu active">
          <a href="#searchpage" id="search_li">
            <i class="fa fa-search" title="Profile Search"></i><span>Profile Search</span>
         ...
         <li  class="mainmenu hidden">
          <a href="#typesofappln" id="typesofappln_li">
        ...
        <li class="treeview mainmenu hidden">
          ...
          <ul class="treeview-menu">
            ...
            <li class="submenu" title="Expected Funds Inflow and Outflow"><a href="#sourceofincome" id="cashflowst_li"><i class="fa fa-money" title="Cash Flow Statements - Source of Income, Annual Expenditure"></i> <span>Cash Flow Statements</span></a></li>
            <li class="submenu"><a href="#contingencyplan" id="contigency_li"><i class="fa fa-bed" title="Contigency Plan"></i> <span>Contigency Planning</span></a></li>
  ...
  <div class="content-wrapper" id="contentBody" >
    ...
    <section class="content">
		...
		<div id="allpages"> 
			...
			<div id="typesofappln" class="pagecontent autosavetrigger"  data-desc="CLIENTFLG">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-header">
        ...
        <div class="col-md-6">
        	<div class="row">
        	   <div class="col-md-3 col-sm-3 col-xs-3">
           		...
           		<div class="col-md-3 col-sm-9 col-xs-9">  
           			<span  id="txtFldRDClientName" class="control-label pull-left"  style="color:#50907C;font-weight: bold;"></span> 
			 	</div>
			 	...
			 	<div class="col-md-3 col-sm-3 col-xs-3">
           		...
           		<div class="col-md-3 col-sm-9 col-xs-9">  
           			<span  id="txtFldRDSpouseName" class="control-label pull-left" style="color:#50907C;font-weight: bold;"></span> 
			 	</div>
        	...
        	<div class="row">
			 	...
			 	<div class="col-md-3 col-sm-3 col-xs-3">
            		<span  id="txtFldRDClientAge" class="control-label pull-left" style="color:#50907C;font-weight: bold;"></span>								
            	</div>
            	...
            	<div class="col-md-3 col-sm-3 col-xs-3">
			 	...
			 	<div class="col-md-3 col-sm-3 col-xs-3">
            		<span  id="txtFldRDSpouseAge" class="control-label pull-left"
            		 style="color:#50907C;font-weight: bold;"></span>								
            	</div>
        ...
        <div class="col-md-2 text-right">
		  ...
		  <a class="btn btn-default reset-icon hidden" id="btnRetReset"></a>   
		</div>
   ...
   <fieldset class="fieldsetClsborder" >  
    ...
    <div class="row">  		  
		...
		<tr><th colspan="4" class="text-center"><h4><span class="control-label" style="color:#50907C;font-weight: bold;">Assumption</span></h4></th>
		</tr>
		<tr>
			<th style="background:none;vertical-align: middle;!important"><br/>&nbsp;&nbsp;<br/></th>
		...
		<thead style="vertical-align: middle;"> 
		<tr><th colspan="4" class="text-center"><h4><span class="control-label" style="color:#50907C;font-weight: bold;">Living Needs during retirement(today's cost)</span></h4></th>
		<tr>
			...
			<div class="text-center col-md-10" id="rpcfana_expndchart">	
				<!-- <fieldset class="fieldsetClsborder" > -->
					 <!--  <legend class="control-label" style="color:#50907C;font-weight: bold;" >Projection of Expenditure</legend> -->
					  <div id="projectionOfExp"  style="text-align:center;overflow-x: auto;" >					  	
					  </div>
				<!-- </fieldset> -->
			 </div>
			<div class="col-md-1"></div>
	...
	<div class="row">
			...
			<div class="text-center col-md-10" id="rpcfana_incomechart">	
				<!-- <fieldset class="fieldsetClsborder"> -->
					  ...
					  <div id="projectionOfInc"  style="text-align:center;overflow-x: auto;" ></div>
				<!-- </fieldset> -->
			 </div>
			 <div class="col-md-1"></div>
			 </div>
      ...
      <div class="tab-pane active" id="AnnualBased">
		...
		<div class="col-md-6">	
			...
			<div class="text-center" id="rpcfana_annlexpinc">	
				<!-- <fieldset class="fieldsetClsborder" > -->
					<!--   <legend class="control-label" style="color:#50907C;font-weight: bold;" >Cash Flow Projection on Retirement</legend> -->
					  <div id="CashFlwprojectionOnRtmnt" style="text-align:center;overflow-x: auto;" ></div>
...
<div class="modal fade" id="OthRet_Dialog" style="display: none"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog scrollModelBodyWidth1000" role="document">
	...
	<div class="col-md-6 col-sm-6 col-xs-6 ">  
			  <label class="control-label mandFldastrks pull-right text-right"
					for="txtFldDlgORtyofpay">Type of payment*
				</label> 
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
	...
	<div class="col-md-6 col-sm-6 col-xs-6 ">  
           ...
           <div class="col-md-6 col-sm-6 col-xs-6"> 
           <!-- <select name="txtFldDlgORAgePaySts" id="txtFldDlgORAgePaySts" 
...
<!-- 				 class="form-control numbers applyEvntYrs"   onmouseover="fipaTooltip(this);"  maxlength="20"/>  -->
	...
	<div class="col-md-6 col-sm-6 col-xs-6 ">  
           ...
           <div class="col-md-6 col-sm-6 col-xs-6"> 
          <!--  <select name="txtFldDlgORAgePayends" id="txtFldDlgORAgePayends" 
				 class="form-control"   onmouseover="fipaTooltip(this);"> 
				 	<option value="">--SELECT--</option>
				 </select>  -->
             <div class="input-group input-group-sm fld-resp-sm"> 
       ...
       <div class="form-group">
							<div class="row">
								...
								<div class="col-md-6 col-sm-6 col-xs-6">
									<textarea name="txtFldDlgORRemarks" id="txtFldDlgORRemarks" class="form-control" rows="5" maxlength="300"></textarea>
...
<script src="plugins/datatable/dataTables.responsive.js"></script>
 ...
 <script src="plugins/d3_charts/d3script.js"></script>   
	...
	<script src="plugins/fipa/js/fipa.plandets.js"></script>   
	...
	<script src="plugins/fipa/js/fipa.instantProSave.js"></script>   
