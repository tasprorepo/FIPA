                     ...
                     <table class="table hover no-border">
                      <tbody>
                        ...
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height4vh">                              
                                <label for="" class="text-right">Plan name<span class="mandFldastrks">*</span></label>                              
                            </div>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height4vh">                              
                                <label for="lblsumassured" class="text-right">Sum Assured<span class="mandFldastrks">*</span></label>                              
                            </div>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height4vh">                            
                                <label for="lblpremium" class="text-right">Premium<span class="mandFldastrks">*</span></label>                            
                            </div>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height4vh">
                                <label for="lblinceptdate" class="text-right">Inception Date<span class="mandFldastrks">*</span></label>
                            </div>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td class="cvborder-topbottom-head">
                            <div class="height4vh">
                                <label for="lblpremterm" class="text-right">Premium Term</label>
                            </div>
                          </td>
                        </tr>
                      ...
                      <table id="cvplnleftpaneltbl" class="table hover no-border">
                        <tbody>
                            ...
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh" >                                  
                                  <div class="autocomplete">
                                    ...
                                    onmouseover="fipaTooltip(this);"  onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this)"/>
                                  </div>
                              </div>
                            </td>
                          </tr>
                          ...
                          <tr>
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh">
                                  <div class="input-group input-group-sm fld-resp-mm" id="">
                           ...
                           <tr>
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh">
                                  <div class="input-group input-group-sm fld-resp-mm">
                                    <div class="input-group-addon"><span class="glyphicon addDollarSign" id="symbolUsd"></span></div>
                                    <input name="txtFldPrem"  id="txtFldPremB00" class="form-control fld-resp-sm numbers applyEvntUsd cashflowst" type="text" onmouseover="fipaTooltip(this);" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
                                  </div>
                              </div>
                            </td>
                          </tr>
                            ...
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh">
                                  <div class="input-group input-group-sm fld-resp-mm date" id="txtFldIncDatePickeB00">
                                    <input name="txtFldIncDate"  id="txtFldIncDateB00" class="form-control fld-resp-mm cashflowst" onmouseover="fipaTooltip(this);" type="text" maxlength="10" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);changeNRExpDate(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
                            ...
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh">
                                  <div class="input-group input-group-sm fld-resp-mm " id="">
                                    ...
                                    <input name="txtFldPremTr"  id="txtFldPremTrB00" class="form-control fld-resp-sm font10 cashflowst" type="text" maxlength="75" onmouseover="fipaTooltip(this);" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);changeNRExpDate(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
                                  </div>
                              </div>
                            </td>
                          </tr>
                            ...
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh">
                                  <div class="input-group input-group-sm fld-resp-mm date" id="txtFldPolExpDatePickeB00">
                                    <input  name="txtFldPolExpDate" id="txtFldPolExpDateB00" class="form-control fld-resp-mm" onmouseover="fipaTooltip(this);" type="text" maxlength="10" onchange="onchangePlanMode(this);onchangeExpDate(this);newlifesyncCPF(this);newlifesyncSRS(this)">
                                    <div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div>
                                  </div>
                              </div>
                            </td>
                            ...
                            <td class="cvborder-topbottom">
                              <div class="covM0 height4vh">
                                  <select name="selPaymode" id="selPaymodeB00"
                                    class="form-control fld-resp-mm cashflowst" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
                                    <option value="">--SELECT--</option>
                                    <option value="ANNUALLY">ANNUALLY</option>
                                    <option value="HALF YEARLY">HALF YEARLY</option>
                                    <option value="QUARTERLY">QUARTERLY</option>
                    ...
                    <table class="table table-bordered display hover" style="min-width:35%;max-width:75%">                    	
                        ...
                        <tr>
                          ...
                          <td><span class='control-label' id='covExpiry'>
                            </span><span class='control-label  hidden ' id='covRef'></span>
                            <span class='control-label  hidden ' id='covMode'>I</span>
                            <span class='control-label  hidden ' id='covPayMtd'></span>
                            <span class='control-label  hidden ' id='covMultion'></span>
			     <span class='control-label  hidden mandFldastrks' id='covSA'></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          </td>
	                          ...
	                          <tbody>
	                            ...
	                            <tr>
	                              <td  class="coverageTh" align="right">
	                                <div style="width:200px;">
	                                  Min Amt Assured(MAA) after Mult/Boost
	                                </div>
	                              </td>
	                              <td align="center">
	                                <div >
              ...
              <div id="PLANCOVRET_APD"  >
                <div id="plancovRetMandatoryFlds">
                  <div id="visCoverRet" style="height: 78vh;overflow: scroll;">
                    <div class="col-md-12" >
                      <span class="panelHeaderTitle"><u>Types of Benefits : Retirement Planning</u></span>
                      <div class="clearspace10"></div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
            ...
            <div class="tab-pane fade" id="li_EducationPlg_tab"  style="height:80vh">
              <div id="PLANCOVEDU_APD"  >
                <div id="plancovEduMandatoryFlds">
                  <div id="visCoverEdu" >
                    <div class="form-group">
                      <span class="panelHeaderTitle"><u>Types of Benefits : Education Planning</u></span>
                      <div class="table-responsive">
                        <div class="btn-group pull-right funcToDisable" role="group">
                          <button type="button"
                            class="btn btn-default navbar-btn delRow-icon"
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body scrollModelBody60">
        <div id="" style="display: inline;"></div>
...
<!--             <button type="button" class="btn btn-default hidden" id="covback00"><span class="fa fa-arrow-left"></span>&nbsp;Back to Coverage Section</button> -->
<!--             <button type="button" class="btn btn-success hidden"  id="covSave00">Ok</button> -->
<!--             <button type="button" class="btn btn-danger hidden" id="covClose00" data-dismiss="modal">Close</button>   -->
          </div>
  ...
  <table id="riderAppendTable">
    <tbody>
        ...
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh" >
              <input name="selplan" id="selplanR00"
                ...
                onmouseover="fipaTooltip(this);" autofocus="true" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this)"  />
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <div class="input-group input-group-sm fld-resp-mm " id="">
                <div class="input-group-addon"><span class="glyphicon addDollarSign" id="symbolUsd"></span></div>
                <input name="txtFldSA" id="txtFldSAR00" class="form-control fld-resp-sm numbers applyEvntUsd" type="text"    onmouseover="fipaTooltip(this);" onchange="onchangePlanMode(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
              </div>
          </div>
        </td>
      </tr>
      ...
      <tr>
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <div class="input-group input-group-sm fld-resp-mm " id="">
                <div class="input-group-addon"><span class="glyphicon addDollarSign" id="symbolUsd"></span></div>
                <input name="txtFldPrem" id="txtFldPremR00"  class="form-control fld-resp-sm numbers applyEvntUsd cashflowst" type="text" onmouseover="fipaTooltip(this);"    onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
              </div>
          </div>
        </td>
      </tr>
        ...
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <div class="input-group input-group-sm fld-resp-mm date" id="txtFldIncDatePickeR00">
                <input name="txtFldIncDate" id="txtFldIncDateR00"  class="form-control fld-resp-mm cashflowst" onmouseover="fipaTooltip(this);"    type="text" maxlength="10" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);changeNRExpDate(this);ilifeInsPremium(null);calcTotSAPremPlandetails();">
                <div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div>
              </div>
          </div>
        </td>
      ...
      <tr>
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <div class="input-group input-group-sm" >
                <div class="input-group-addon"><span><label class="switchs" style="float:left">
                  <input id="swtDlgliplnPremTerm" class="csscheckbox cashflowst" type="checkbox" checked onchange="onchangePremTerm(this);onchangePlanMode(this);changeNRExpDate(this)"  >
                  <span class="sliders round"></span>
                  <span class="absolute-no"><small>WHOLE LIFE</small></span>
                  </label></span>
                </div>
                <input name="txtFldPremTr" id="txtFldPremTrR00"  class="form-control fld-resp-sm font10 cashflowst" type="text" maxlength="75" onmouseover="fipaTooltip(this);" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);changeNRExpDate(this);ilifeInsPremium(null);calcTotSAPremPlandetails();"  >
              </div>
          </div>
        </td>
      </tr>
        ...
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <div class="input-group input-group-sm fld-resp-mm date" id="txtFldPolExpDatePickeR00">
                <input name="txtFldPolExpDate" id="txtFldPolExpDateR00" class="form-control fld-resp-mm" onmouseover="fipaTooltip(this);" type="text"   maxlength="10" onchange="onchangePlanMode(this);onchangeExpDate(this);newlifesyncCPF(this);newlifesyncSRS(this)">
                <div class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></div>
              </div>
          </div>
        </td>
      ...
      <tr>
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <select name="selPaymode" id="selPaymodeR00" class="form-control fld-resp-mm cashflowst" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);ilifeInsPremium(null);calcTotSAPremPlandetails();"  >
                <option value="">--SELECT--</option>
                <option value="ANNUALLY">ANNUALLY</option>
                <option value="HALF YEARLY">HALF YEARLY</option>
                <option value="QUARTERLY">QUARTERLY</option>
      ...
      <tr>
        <td class="cvborder-topbottom">
          <div class="covM0 height4vh">
              <select name="selPaymtd" id="selPaymtdR00" 	class="form-control fld-resp-mm cashflowst" onchange="onchangePlanMode(this);newlifesyncCPF(this);newlifesyncSRS(this);ilifeInsPremium(null);calcTotSAPremPlandetails();"  >
                <option value="">--SELECT--</option>
                <c:if test="${not empty LI_PAYMETHODS_LIST}">
                  <c:forEach var="paymthds" items="${LI_PAYMETHODS_LIST}">
                    <option value="${paymthds}">${paymthds}</option>
                    ...
                    <table id="planCoveragestbl" class="dataTable table-bordered table-striped display hover" style="width: 100%;" >
                      <thead>
                        <tr>
                          ...
                          <th>
                            <div style="width: 160px">Expiry Period of MAA</div>
                          </th>
                          <th>
							...
							<div class="checkbox checkbox-primary bold" onclick="coveragesCheckEvent(this,'All')">
								...
								<tr valign="top"  > 
											...
											<div class="checkbox checkbox-primary" onclick="coveragesCheckEvent(this,'All')">
												 ...
												 <label class="control-label" for="txtFldCov03"  >Expiry Period of MAA</label>
											 </div> 
												</div> 
												</td>
                     ...
                     <tbody>
                        ...
                        <td align="center">
                          <div >
                            <div class="input-group input-group-sm fld-resp-mm" id="">
                              ...
                              <input id="" name="" class="form-control numbers applyEvntUsd" type="text"  onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();toCalMAA('mulBootDeath','maaDeath')">   		  
                              <span class="mandFldastrks" style="position: absolute;">*</span>
                            </div>
                          </div>
                        </td> 
                      ...
                      <tr>  <!-- Row 1  --> 
                        <td align="center">
                          <div >
                            <div class="input-group input-group-sm fld-resp-mm" id="">
                              <div class="input-group-addon"><span class="glyphicon addDollarSign" id="symbolUsd"></span></div>
                              <input id="" name="" class="form-control numbers applyEvntUsd" type="text" onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();">
                              <span class="mandFldastrks" style="position: absolute;">*</span>
                            </div>
                          </div>
                        </td>  
                      ...
                      <tr> <!-- Row 2-->  
                        <td align="center">
                          <div >
                            <div class="input-group input-group-sm fld-resp-mm" id="">
                              <input id="" name="" class="form-control applyEvntYrs" type="text"   onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();">
                              <div class="input-group-addon">
                                <span id="symbolYrs"></span>
                              </div>
                              <span class="mandFldastrks" style="position: absolute;">*</span>
                      ...
                      <tr>  <!-- Row 3 --> 
                        <td align="center">
                          <div >
                            <div class="input-group input-group-sm fld-resp-mm" id="">
                              <input id="" name="" class="form-control applyEvntYrs" type="text" value="1" onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();">
                              <div class="input-group-addon">
                                <span id="symbolYrs"></span>
                              </div>
                            </div>
                      ...
                      <tr> <!-- Row 7-->
                        <td align="center">
                          <div >
                            <div id=""><input id="" name="" class="form-control" type="text" maxlength="150" onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();"></div>
                          </div>
                        </td> 
                      </tr>
                      <tr> <!-- Row 8-->
                        <td align="center">
                          <div >
                            <div class="input-group input-group-sm fld-resp-mm" id="">
                              <div class="input-group-addon"><span class="glyphicon addDollarSign" id="symbolUsd"></span></div>
                              <input id="" name="" class="form-control applyEvntUsd" type="text" onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();">
                            </div>
                          </div>
                        </td> 
                      </tr>
                      ...
                      <tr> <!-- Row 10-->
                        <td align="center">
                          <div >
                            <div id="">
                              <input id="" name="" class="form-control" type="text" maxlength="150" onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();">
                            </div>
                          </div>
                        </td> 
                      </tr>
                      <tr> <!-- Row 11-->
                        <td align="center">
                          <div >
                            <div id="">
                              <input id="" name="" class="form-control" type="text" maxlength="300" onmouseover="fipaTooltip(this);" onchange="onChangeCovTextMode();">
                              <input type="hidden"  id="" name="hCoveragePKId"> 
                            </div>
                          </div>
                        </td> 
                      </tr>
