		...
		<div class="panel-body" style="margin-left: 35px;">
					...
					<div class="row">
						<div class="col-md-9 bg-warning"
							style="box-shadow: 0 0px 1px 0 rgba(0, 0, 0, 0.2), 0 1px 6px 0 rgba(0, 0, 0, 0.19);">
							<div class="checkbox checkbox-primary bold">
								To view reports, click the respective icon(s) and Generate
								Report . &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
									id="chkAllReport" name="chkAllReport" type="checkbox"
									value="Select All" onclick="reportCheckEvent(this,'rpt')">
								<label for="chkAllReport">Select All </label>
							</div>
						</div>
						<div class="col-md-3">
			...
			<div class="row">
				<div class="col-md-12" id="analysisTypesdiv">
					...
					<div class="row">
						...
						<div class="col-md-2 col-md-2 col-md-2 box-line">
							<div class="checkbox checkbox-primary">
								<input id="chkreport3" name="chkrpt" type="checkbox" value="RET"
									onclick="reportCheckEvent(this,'All')"> <label
									for="chkreport3"> <img
									src="images/menuicons/Picture41.png" class="img-thumbnail" target="_new" style="margin-top: -6px;">
								</label>
							</div>
							<div class="caption">Retirement Planning</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-1">&nbsp;</div>
<!-- 							<button type="button" class="btn btn-primary text-center"  id="btnRPCFAnalysisRep"> -->
...
<!-- 							</button> -->
				...
				<div class="btnStyle"> 
					    <button type="button" id="btnRPCFAnalysisRep" class="btn BtnFIPASRCH StylishSRCH text-center"  >
