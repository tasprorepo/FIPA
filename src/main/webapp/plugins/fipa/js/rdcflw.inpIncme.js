							 ...
							 if($agebased == "SELF"){
								 if($freq == "REGULAR"){
									 if(i >= $startslfage &&  (i<=$endage)){
										 if(i==$startslfage){
											 arrlist[arrHdr2]=(isNaN($anlinc)) ? 0 : RemDecimalNumber(Number($anlinc));  
										 }else{
											 var olddataAno=dataset[dataset.length-1][arrHdr2]; 
											 olddataAno*=(1+($esclrate/100));
											 arrlist[arrHdr2]=(isNaN(olddataAno)) ? 0 : RemDecimalNumber(Number(olddataAno));  
										 }
									 }else{
										 arrlist[arrHdr2]='';
									 }
...
//						 var hdrTest=hdr;
							 ...
							 if($agebasedlt == "SELF"){ 
								 if($freqlt == "REGULAR"){
									 if(i >= $startslfagelt &&  (i<=$endagelt)){ 
										 if(i==$startslfagelt){ 
											 arrlist[arrHdr]=(isNaN($anlinclt)) ? 0 : RemDecimalNumber(Number($anlinclt));   
										 }else{   
			 ...
			 var annlincome = (isNaN(totAnlExp)) ? 0 : RemDecimalNumber(Number(totAnlExp));
			 var accmincome = 0;		 			
