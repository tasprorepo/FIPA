...
//			    		var tempFamIns =$("#expdFamilyInsurance").val(); 
//			    		
//			    	 $("#expdSelfInsurance").val(remPriceAfDec(strPremAmtSlf)); 
...
//					 }
//				     $("#expdSpsInsurance").val(remPriceAfDec(strPremAmtSps));
...
//					 }
//				     $("#expdFamilyInsurance").val(remPriceAfDec(strPremAmtFam));   
...
//			 
//			 
////			 remPriceAfDec - req to remove round off
