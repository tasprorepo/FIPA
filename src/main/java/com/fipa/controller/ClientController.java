...
//		System.out.println( redirectAttributes.getFlashAttributes().get("FIPA_CUSTID") );
...
//		System.out.println("strMenuName -------->"+strMenuName);
...
//	
		...
		String strCustId = jsnKeyObj.getString("fnaId");
		String strCustname = jsnKeyObj.getString("selfName");
		String strCustnric = jsnKeyObj.getString("selfNric");
		String strFpmsCustId = jsnKeyObj.getString("fpmsCustId");
...
//		System.out.println( model.get("FIPA_CUSTID") );
