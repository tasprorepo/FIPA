...
//		System.out.println("strSaveFor------------->"+strSaveFor + ",strFnaId------------->"+strFnaId);
...
//			if(strSaveFor.equals("FPMS_CLIENT")){ 
//				 String strClientId = "";
...
//						 strArrDets.put(0,strClientId);
//						 strArrDets.put(1,selfspsDets.getDfSelfName());
//						 strArrDets.put(2,selfspsDets.getDfSelfNric());
//					 }else{
...
//					  
//					 String strAdvDclId=FipaUtils.getParamValue(request, "advDecId");
//					 
...
//						 
//						 strAdvDclId = clientDB.saveAdvDeclareDetails(fnaAdvDclDets,strClientId);
//						 
//					 }else{
//						  strAdvDclId=fnaAdvDclDets.getAdvDecId();
//						  fnaAdvDclDets.setAdvDecId(strAdvDclId);
//						 
//						 fnaAdvDclDets.setAdvDecModBy(strCrtdUser);
//						 fnaAdvDclDets.setAdvDecModDate(new Date()); 
//						 fnaAdvDclDets.setFnaSelfspouseDets(selfspsDets);
//						 
//						 clientDB.updateAdvDclDetails(fnaAdvDclDets);
//					 }
//					 
//					 
//					 clfeDataJsnObj.put("advDecId", strAdvDclId); 
//					 clfeDataJsnArr.put(clfeDataJsnObj);
//					 clfeTabJsnObj.put("ADVDECLR_DETS", clfeDataJsnArr); 
//					 
//				 }
//				 
//				 
//				 
//			}
//		String strFNAId = (String) idlist.get(0);
//		System.out.println(strFNAId);
//		
//		JSONObject jsonObj = new JSONObject();
