...
<div class="modal fade" id="Cob_Dialog" style="display: none"  tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  style="z-index:1053 !important">
  <div class="modal-dialog scrollModelBodyWidth1000" role="document">
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
			  ...
			  Main Account Holder Name</label>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
             ...
             Supp. Account Holder Name </label>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6"> 
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
      ...
      <div class="form-group">
      <fieldset  id="regulardeposit"><legend class="customFIPAStyle">Regular Deposit</legend>
	...
	<div class="row" >
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
             <label class="control-label pull-right text-right" for="txtFldDlgCOBRegDeposit">Regular Deposit if any</label>
             </div> 
           <div class="col-md-6 col-sm-6 col-xs-6">  
	...
	<div class="col-md-6 col-sm-6 col-xs-6 "> 
      ...
      <div class="form-group">
      <fieldset  id="Objective"><legend class="customFIPAStyle">Objective</legend>
