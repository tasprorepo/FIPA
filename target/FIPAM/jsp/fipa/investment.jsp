		...
		<div class="table-responsive"> 
			...
			<div class="col-md-3 pull-left"> 
				<div class="btn-group pull-left" role="group">
					 <a class="btn btn-default backToFdFlow" id="backToFdFlowInv" onclick="openBackToFundFlow('incsrcSelfNempDivdamt');"></a>
...
<!-- 						<button type="button"  class="btn btn-default navbar-btn delRow-icon"  id="InvestDRow"></button> -->
