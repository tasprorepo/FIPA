			...
			<div class="modal-body" style="max-height:90vh;overflow:auto;">
			 ...
			 <div class="nav-tabs-custom">
			 	 <ul class="nav nav-tabs">
			 	 	...
			 	 	<li class="pull-right header"><button type="button"  class="btn BtnFIPACAN StylishCAN"   data-dismiss="modal">
					      <span class="txt">Close</span>
					      <span class="round"><i class="fa fa-times"></i></span>
					    </button></li>
			 ...
			 <div class="tab-content">
			 	<div class="tab-pane active" id="Before_Retirement">
					...
					<div class="col-md-12">
						<div id="before_retire_chart" style="text-align:center;overflow-x: auto;" ></div>
					</div>
